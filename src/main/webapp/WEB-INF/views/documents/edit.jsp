        ...
        <div class="field-grid">
            ...
            <label class="field">Category *
                <select name="category" required>
                    ...
                    <option value="Facilities" ${document.category == 'Facilities' ? 'selected' : ''}>Facilities</option>
                    <option value="Audit" ${document.category == 'Audit' ? 'selected' : ''}>Audit</option>
    ...
    <section class="card form-section">
        ...
        <div class="upload-grid">
            <div class="upload-box image-upload-card" data-image-collector>
                <strong class="upload-title">Replace Main PDF with Images</strong>
                <small class="upload-help">
                    Select one or several replacement pictures. Open the picker again to add more.
                    These pages will replace the current main PDF when the correction is saved.
                </small>

                <div class="image-picker-row" data-image-picker-host>
                    <input
                        id="editCaptureImages"
                        ...
                        data-image-input
                    >
                    <label class="btn btn-secondary image-picker-button" for="editCaptureImages">
                        Choose Images
                    </label>
                ...
                <div class="selected-image-area" data-image-area hidden>
                    <div class="selected-image-header">
                        <strong>Selected Replacement Pages: <span data-image-count>0</span></strong>
            ...
            <label class="upload-box">
                ...
                <span>Used only when no replacement images are selected.</span>
                <input  class="file-control" 
                        type="file" 
                        name="primaryPdf" 
                        accept="application/pdf" 
                        data-file-list="edit-pdf-list">
            </label>
        </div>
