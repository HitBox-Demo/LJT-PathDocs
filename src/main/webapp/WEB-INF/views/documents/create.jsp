...
<form method="post" action="${ctx}/documents/create" enctype="multipart/form-data" class="form-layout">
    ...
    <section class="card form-section">
        ...
        <div class="upload-grid">
            <label class="upload-box"><strong>Capture / choose images</strong><span>JPG, JPEG or PNG · Multiple pages allowed</span><input type="file" name="captureImages" accept="image/*" capture="environment" multiple data-file-list="image-list"></label>
            <label class="upload-box"><strong>Upload existing PDF</strong><span>Used only when no camera images are selected</span><input type="file" name="primaryPdf" accept="application/pdf" data-file-list="pdf-list"></label>
        </div>
        <div id="image-list" class="selected-files"></div><div id="pdf-list" class="selected-files"></div>
    </section>
    ...
    <section class="card form-section">
        ...
        <div class="field-grid">
            ...
            <!-- <label class="check-field"><input type="checkbox" name="confidential" value="Y"> Mark as Confidential</label> -->
    ...
    <section class="card form-section">
        ...
        <label class="upload-box compact"><strong> Add attachments</strong><span>PDF, JPG, PNG, DOC, DOCX, XLS or XLSX</span><input type="file" name="attachments" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.xls,.xlsx" multiple data-file-list="attachment-list"></label>
