...
<section class="page-heading">
    <div>
        ...
        <p>Create accounts and assign the initial role and department.</p>
    </div>
</section>

<details class="card collapsible" ${empty error ? '' : 'open'}>
...
<section class="card table-card">
    <div class="table-wrap" role="region" aria-label="User table" tabindex="0">
                ...
                <c:forEach items="${users}" var="u">
                    <tr>
                        <td class="wrap-cell">
                            ...
                            <small>@<c:out value="${u.username}"/></small>
                        </td>
                        ...
                        <td class="wrap-cell"><c:out value="${u.departmentName}"/></td>
                        <td><span class="badge status-routed"><c:out value="${u.status}"/></span></td>
                        <td>
                            <form method="post" action="${ctx}/admin/users" class="role-request-inline">
                                <input type="hidden" name="csrfToken" value="${csrfToken}">
                                ...
                                <button class="btn btn-small btn-outline" type="submit">Request</button>
                            </form>
                        </td>
                    </tr>
                </c:forEach>
